...
# ---------------------------------------------------------------------------
# Project paths, manifest, and per-project memory loading were extracted to
# paths.py and storage.py. Re-imported here so this module's own call sites --
# and external imports of `claude_engram.hooks.remind` -- keep resolving.
# ---------------------------------------------------------------------------
