        ...
        inputSchema={
            ...
            "properties": {
                "operation": {
                    ...
                    "description": "Operation to perform. run_report: write and return this session's auditable run report (<project>/.engram/runs/) -- hook-captured facts only: commits, turns, files with edit counts, tests, errors, compactions with sizes and what each restored, checkpoints deliberate vs auto, goal text and verdicts. run_status: the goal run as engram recorded it from the transcript (a person types /goal; engram brackets it: turns, cap, how it ended). There is no op to start or end a goal.",
                },
                "project_path": {"type": "string", "description": "Project directory"},
                "query": {
                    "type": "string",
