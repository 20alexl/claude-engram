...
# so the pre-edit hook never imports this pydantic-heavy module). Re-exported
# here for back-compat: external code imports them from tools.memory.
from ..hooks.hot_reader import (  # noqa: F401
    CATEGORY_BONUSES,
